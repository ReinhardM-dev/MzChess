...
def handleNotifyError(app, qtbot, expectedMessage : str):
 ...
 okButton = app.msgBox.button(QtWidgets.QMessageBox.Ok)
 assert isinstance(okButton, QtWidgets.QPushButton)
 if app.msgBox.isVisible():
  qtbot.mouseClick(okButton, QtCore.Qt.LeftButton, delay=1)
...
def test_placementBoard(app, qtbot):
 ...
 qtbot.mouseClick(button, QtCore.Qt.LeftButton)
 qtbot.mouseClick(app.placementBoard.pushButtonList[0], QtCore.Qt.LeftButton)
